...
from maddpg.trainer.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer

slim = tf.contrib.slim
# replay_buffer = ReplayBuffer(1e6)
priority_replay_buffer = PrioritizedReplayBuffer(1e6, 0.6)
...
def parse_args():
    ...
    parser.add_argument("--alpha", type=float, default=0.6, help="the priority replay buffer factor")
...
def train(arglist, PID=None, lock=None):
    ...
    with U.single_threaded_session() as sess:
        ...
        learners = get_agents(env, num_adversaries, obs_shape_n, arglist, "learner")
